...
The `B2BUtils` package provides some command line utilities to help administration and development of business processes.

The tools are "work in progress" and in different states of maturity.
