 ...
 *         &lt;element name="outboundACLRequired" type="{http://www.w3.org/2001/XMLSchema}string" minOccurs="0"/>
...
@XmlType(name = "",
    propOrder = { "createdBy", "createdTimestamp", "description", "forceToUnlock", "formatVer", "formatVersion", "inboundNodes", "lastModifiedBy",
        "lastModifiedTimestamp", "lockedBy", "lockedTimestamp", "name", "outboundACLRequired", "protocol", "status", "templateName", "verStamp" })
...
public class NetmapDef {
  ...
  protected String       outboundACLRequired;
  ...
  /**
   * Gets the value of the outboundACLRequired property.
   * 
   * @return
   *     possible object is
   *     {@link String }
  ...
  /**
   * Sets the value of the outboundACLRequired property.
   * 
   * @param value
   *     allowed object is
   *     {@link String }
   *     
   */
  public void setOutboundACLRequired(String value) {
    this.outboundACLRequired = value;
  }
  ...
  public String toString() {
    return "NetmapDef [name=" + name + ", description=" + description + ", protocol=" + protocol + ", inboundNodes=" + inboundNodes + ", outboundACLRequired="
        + outboundACLRequired + ", forceToUnlock=" + forceToUnlock + ", status=" + status + ", createdBy=" + createdBy + ", createdTimestamp="
        + createdTimestamp + ", formatVer=" + formatVer + ", formatVersion=" + formatVersion + ", lastModifiedBy=" + lastModifiedBy + ", lastModifiedTimestamp="
        + lastModifiedTimestamp + ", lockedBy=" + lockedBy + ", lockedTimestamp=" + lockedTimestamp + ", templateName=" + templateName + ", verStamp="
        + verStamp + "]";
  }
